...
class LlmClientMessage(BaseModel):
    ...
    message_id: str | None = Field(
        default=None,
        description=(
            "A client-assigned stable identifier for this message. Used to "
            "anchor conversation summaries to a specific message."
        ),
    )
...
class LlmClientSummaryMessage(BaseModel):
    """A summary of earlier conversation messages, generated by an agent and
...
class QueryRequest(BaseModel):
    messages: list[
        LlmClientFunctionCallResultMessage | LlmClientMessage | LlmClientSummaryMessage
    ] = Field(description="A list of messages to submit to the copilot.")
...
class ConversationSummarySSEData(BaseModel):
    content: str = Field(description="The summary text of the covered messages.")
    covered_through_message_id: str = Field(
...
class ConversationSummarySSE(BaseSSE):
    event: Literal["copilotConversationSummary"] = "copilotConversationSummary"
